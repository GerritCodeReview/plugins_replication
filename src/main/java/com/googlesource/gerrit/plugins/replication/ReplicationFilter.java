...
public class ReplicationFilter {
  ...
  private final List<String> projectPatterns = Collections.<String>emptyList();
  private final List<String> excludePatterns = Collections.<String>emptyList();

  public ReplicationFilter(List<String> includePatterns, List<String> excludePatterns) {
    projectPatterns = Objects.requireNonNullElse(includePatterns, projectPatterns);
    this.excludePatterns = Objects.requireNonNullElse(excludePatterns, this.excludePatterns);
  }
