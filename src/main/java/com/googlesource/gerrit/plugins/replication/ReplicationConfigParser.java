...
public class ReplicationConfigParser {
  ...
  List<RemoteConfiguration> parseDynamicConfigs(DynamicReplicationFileBasedConfigs replicationConfigs,ReplicationConfig staticReplicationConfig) throws ConfigInvalidException{
