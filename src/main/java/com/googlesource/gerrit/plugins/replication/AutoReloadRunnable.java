...
public class AutoReloadRunnable implements Runnable {
  ...
  private final DynamicItem<ReplicationConfigValidator> configValidator;
  ...
  public AutoReloadRunnable(
      DynamicItem<ReplicationConfigValidator> configValidator,
  ...
  synchronized void reload() {
    ...
    try {
      ...
      final List<DestinationConfiguration> newValidDestinations =
          configValidator.get().validateConfig(newConfig);
