...
class SecureCredentialsProvider extends CredentialsProvider {
  ...
  private final String cfgPassphrase;

  SecureCredentialsProvider(String user, String pass, String passphrase) {
    cfgUser = user;
    cfgPass = pass;
  ...
  public boolean get(URIish uri, CredentialItem... items)
    ...
    if (username == null && cfgPassphrase == null) {
      return false;
    }
    ...
    if (password == null && cfgPassphrase == null) {
      return false;
    }
    ...
    for (CredentialItem i : items) {
      if (i instanceof CredentialItem.Username) {
        ...
        ((CredentialItem.StringType) i).setValue(cfgPassphrase);
      } else {
