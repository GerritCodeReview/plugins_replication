...
public class DeleteProjectTask implements Runnable {
  interface Factory {
    ...
    DeleteProjectTask create(
        ...
        com.googlesource.gerrit.plugins.replication.events.ProjectDeletionState state);
  }
  ...
  private final com.googlesource.gerrit.plugins.replication.events.ProjectDeletionState state;
