...
public class ProjectDeletionState {
  ...
  public void setScheduled(URIish uri) {
    setStatusAndBroadcastEvent(
        uri,
        SCHEDULED,
        new ProjectDeletionReplicationScheduledEvent(project.get(), uri.toASCIIString()));
  }
  ...
  public void setSucceeded(URIish uri) {
    setStatusAndBroadcastEvent(
        uri,
        SUCCEEDED,
        new ProjectDeletionReplicationSucceededEvent(project.get(), uri.toASCIIString()));
    notifyIfDeletionDoneOnAllNodes();
  }

  public void setFailed(URIish uri) {
    setStatusAndBroadcastEvent(
        uri, FAILED, new ProjectDeletionReplicationFailedEvent(project.get(), uri.toASCIIString()));
    notifyIfDeletionDoneOnAllNodes();
  }
