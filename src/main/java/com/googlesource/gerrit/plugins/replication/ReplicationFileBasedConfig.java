  ...
  private List<Destination> allDestinations()
    ...
    for (RemoteConfig c : allRemotes(config)) {
      ...
      Destination destination =
          new Destination(injector, c, new DefaultDestinationConfiguration(c, config),
              replicationUserFactory, pluginUser, gitRepositoryManager, groupBackend,
              stateLog, groupIncludeCache, eventDispatcher);
