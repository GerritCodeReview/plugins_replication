...
public class ReplicationRemotesUpdater {
  ...
  public void update(Config remoteConfig) throws IOException {
    ...
    SeparatedRemoveConfigs configs = onlyRemoteSectionsWithSeparatedPasswords(remoteConfig);
  ...
  private SeparatedRemoveConfigs onlyRemoteSectionsWithSeparatedPasswords(Config configUpdates) {
    SeparatedRemoveConfigs configs = new SeparatedRemoveConfigs();
  ...
  private void persistRemotesPasswords(SeparatedRemoveConfigs configs) {
  ...
  private static class SeparatedRemoveConfigs {
