...
public interface ReplicationConfigListener {
   ...
   */
  void reload(ConfigurationChangeEvent configurationChangeEvent) throws ConfigInvalidException;
   ...
   * @throws ConfigInvalidException if the new configuration is not valid.
   */
  void validateNewConfig(ConfigurationChangeEvent configurationChangeEvent)
