...
public class AutoRepairTracker {
  ...
  public boolean tryBeginRepair(Project.NameKey project, URIish uri) {
    ...
    return state.tryBeginRepair(project, uri);
  }
  ...
  private class State {
    ...
    synchronized boolean tryBeginRepair(Project.NameKey project, URIish uri) {
      ...
      if (!canBeginRepair(remainingMs, project, uri)) {
        return false;
      }
      repairAttemptCount++;
    ...
    private boolean canBeginRepair(long remainingMs, Project.NameKey project, URIish uri) {
