...
public class PushAll implements Runnable {
  ...
  public interface Factory {
    PushAll create(String urlMatch, @Nullable String refMatch, ReplicationFilter filter, ReplicationState state, boolean now);
  }
  ...
  protected PushAll(
      ...
      @Assisted @Nullable String refMatch,
  ...
  public String toString() {
    ...
    if (refMatch != null) {
      s = "Replicate [" + refMatch + "] for projects";
    }
    if (urlMatch != null) {
      s = s + " to " + urlMatch;
    }
