...
public class PushAll implements Runnable {
  ...
  public interface Factory {
    PushAll create(String urlMatch, String refMatch, ReplicationFilter filter, ReplicationState state, boolean now);
  }
  ...
  public String toString() {
    ...
    if (PushOne.ALL_REFS.equals(refMatch)) {
      s = s + "All Refs for All Projects";
    } else {
      s = s + "[" + refMatch + "] for All Projects";
    }
    if (urlMatch != null) {
      s = s + " to " + urlMatch;
    }
