...
public enum UrlDistributionStrategy {
  ...
  ROUND_ROBIN {
    ...
    @Override
    public String value() {
      return ROUND_ROBIN_CONFIG;
    }
  };

  protected static final String ALL_CONFIG = "all";
  protected static final String ROUND_ROBIN_CONFIG = "roundRobin";
  ...
  public static UrlDistributionStrategy fromConfig(String value) {
    ...
    return switch (value) {
      case ROUND_ROBIN_CONFIG -> ROUND_ROBIN;
      default -> ALL;
    };
  }
