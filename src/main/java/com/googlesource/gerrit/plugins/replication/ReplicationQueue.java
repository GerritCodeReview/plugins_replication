...
public class ReplicationQueue
  ...
  public void scheduleFullSync(
    ...
    fire(
        ...
        urlMatch,
        List.of(
            new com.google.gerrit.server.extensions.events.GitReferenceUpdated.UpdatedRef(
                PushOne.ALL_REFS, null, null, null)),
        state,
        now);
  }
  ...
  private void fire(String projectName, List<UpdatedRef> updatedRefs) {
  ...
  private void fire(
    ...
    if (!running) {
      ...
      beforeStartupEventsQueue.add(
          ReferencesUpdatedEvent.create(project.get(), ImmutableList.copyOf(updatedRefs)));
      return;
    }
  ...
  abstract static class ReferencesUpdatedEvent {
    ...
    static ReferencesUpdatedEvent create(
        String projectName, ImmutableList<UpdatedRef> updatedRefs) {
      return new AutoValue_ReplicationQueue_ReferencesUpdatedEvent(projectName, updatedRefs);
    }

    public abstract String projectName();

    public abstract ImmutableList<UpdatedRef> updatedRefs();
  }
