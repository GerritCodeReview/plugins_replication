...
public class ReplicationConfigImpl implements ReplicationConfig {
  ...
  private static final int DEFAULT_AUTO_REPAIR_THREADS = 2;
  ...
  private final int autoRepairThreads;
  ...
  public ReplicationConfigImpl(
    ...
    this.autoRepairThreads =
        Math.max(1, config.getInt("replication", "autoRepairThreads", DEFAULT_AUTO_REPAIR_THREADS));
  ...
  @Override
  public int getAutoRepairThreads() {
    return autoRepairThreads;
  }
}
