...
public class Destination {
  ...
  /**
   * Override this method to inject a custom implementation of AdminApiFactory. This makes it
   * possible to perform admin tasks (e.g. create project) through protocols other than plain SSH.
