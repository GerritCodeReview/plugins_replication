...
public class Destination {
  ...
  private final ConcurrentMap<PushOne.PushOneKey, PushOne> pending = new ConcurrentHashMap<>();
  private final Map<PushOne.PushOneKey, PushOne> inFlight = new HashMap<>();
  ...
  public static class QueueInfo {
    public final Map<PushOne.PushOneKey, PushOne> pending;
    public final Map<PushOne.PushOneKey, PushOne> inFlight;

    public QueueInfo(
        Map<PushOne.PushOneKey, PushOne> pending, Map<PushOne.PushOneKey, PushOne> inFlight) {
  ...
  private void foreachPushOp(
      Map<PushOne.PushOneKey, PushOne> opsMap, Function<PushOne, Void> pushOneFunction) {
  ...
  void schedule(
    ...
    PushOne.PushOneKey pushOneKey = PushOne.PushOneKey.create(project, uri);
  ...
  @Nullable
  private PushOne getPendingPush(PushOne.PushOneKey key) {
