...
public class GerritSshApi {
  ...
  private final ReplicationSshSessionFactory sessionFactory;

  @Inject
  protected GerritSshApi(ReplicationSshSessionFactory sessionFactory) {
    this.sessionFactory = sessionFactory;
  }

  void createProject(CredentialsProvider credentialsProvider, URIish uri,
  ...
  void deleteProject(SecureCredentialsProvider credsProvider, URIish uri, String projectName) {
    OutputStream errStream = newErrorBufferStream();
    String cmd =
  ...
  void updateHead(CredentialsProvider credsProvider, URIish uri,
  ...
  private void execute(CredentialsProvider credentialsProvider, URIish uri,
      String cmd, OutputStream errStream)
      throws IOException {
    try {
  ...
  public URIish toSshUri(URIish uri) throws URISyntaxException {
    if (uri.getHost() != null) {
