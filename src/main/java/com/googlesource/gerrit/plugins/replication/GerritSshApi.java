...
public class GerritSshApi {
  ...
  protected boolean createProject(String remoteName, URIish uri,
  ...
  protected boolean deleteProject(String remoteName, URIish uri,
      String projectName) {
    OutputStream errStream = sshHelper.newErrorBufferStream();
    String cmd =
  ...
  protected boolean updateHead(String remoteName, URIish uri,
  ...
  private void execute(String remoteName, URIish uri, String cmd,
