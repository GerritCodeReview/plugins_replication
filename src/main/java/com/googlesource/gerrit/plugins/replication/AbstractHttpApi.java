...
abstract class AbstractHttpApi implements AdminApi {
  ...
  protected abstract HttpUriRequest newCreateProjectRequest(Project.NameKey project, URIish uri);

  protected abstract HttpUriRequest newDeleteProjectRequest(Project.NameKey project, URIish uri);

  protected abstract HttpUriRequest newUpdateHeadRequest(
  ...
  public boolean createProject(Project.NameKey project, String head) {
    ...
    try {
      return execute(newCreateProjectRequest(project, uri));
    } catch (IOException e) {
  ...
  public boolean deleteProject(Project.NameKey project) {
    ...
    try {
      return execute(newDeleteProjectRequest(project, uri));
    } catch (IOException e) {
  ...
  public boolean updateHead(Project.NameKey project, String newHead) {
    ...
    try {
      return execute(newUpdateHeadRequest(project, newHead, uri));
    } catch (IOException e) {
  ...
  private boolean execute(HttpUriRequest req) throws ClientProtocolException, IOException {
