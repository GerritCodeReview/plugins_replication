...
class PushOne implements ProjectRunnable, CanceledWhileRunning, UriUpdates {
  ...
  public String toString() {
    String print =
        "[" + HexFormat.fromInt(id) + "] push " + uri + " " + getLimitedCommaJoinedRefs();
  ...
  /**
   * Returns a comma separated string of refs limited to the maxRefsToShow config option.
   *
   * <ul>
   ...
   */
  protected String getLimitedCommaJoinedRefs() {
    ...
    String commaSeparatedRefs = "[" + String.join(", ", refs) + "]";
    commaSeparatedRefs = commaSeparatedRefs + " + "+ remainingRefs + " more ref";
    commaSeparatedRefs = (remainingRefs > 1) ? commaSeparatedRefs + "(s)" : commaSeparatedRefs;
    return commaSeparatedRefs;
  }
