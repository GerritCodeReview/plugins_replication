...
public class EventRestApiServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) {
    StartReplicationRequest startReplicationRequest = setStartReplicationRequest(req);
  ...
  private StartReplicationRequest setStartReplicationRequest(HttpServletRequest request) {
