...
public class EventRestApiServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
    ...
    try {
      ...
      repLog.error("Problem starting replication: {}", e.getLocalizedMessage());
    ...
    repLog.debug(
        ...
        startReplicationRequestOpt.get().getCommand(),
        startReplicationRequestOpt.get().getProject(),
        startReplicationRequestOpt.get().getUrl(),
        startReplicationRequestOpt.get().isNow(),
        startReplicationRequestOpt.get().isWait());

    try {
      startReplicationProcessing.execute(startReplicationRequestOpt.get(), res);
    } catch (IOException e) {
