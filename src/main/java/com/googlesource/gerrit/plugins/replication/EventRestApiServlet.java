...
public class EventRestApiServlet extends HttpServlet {
  ...
  @Inject
  EventRestApiServlet(
      StartReplicationProcessing startReplicationProcessing, StartReplicationRequest startReplicationRequest) {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) {
    if (!setstartReplicationRequest(req)) {
      try {
  ...
  private boolean setstartReplicationRequest(HttpServletRequest request) {
    try {
      Gson gson = new Gson();
