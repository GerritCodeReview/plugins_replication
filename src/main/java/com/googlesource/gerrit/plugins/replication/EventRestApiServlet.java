...
public class EventRestApiServlet extends HttpServlet {
  ...
  private StartCommandRequest startCommandRequest;

  private final StartReplicationRequest startReplicationRequest;

  @Inject
  EventRestApiServlet(
      StartReplicationRequest startReplicationRequest, StartCommandRequest startCommandRequest) {
    this.startReplicationRequest = startReplicationRequest;
    this.startCommandRequest = startCommandRequest;
  }
  ...
  private boolean setStartCommandRequest(HttpServletRequest request) {
    try {
      Gson gson = new Gson();
