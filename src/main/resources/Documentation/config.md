...
gerrit.autoReload
:	If true, automatically reload replication destinations and settings
    when replication.config file is updated, without requiring the plugin
    to be reloaded. Existing pending replication events based on old
    settings are discarded. By default, false.
