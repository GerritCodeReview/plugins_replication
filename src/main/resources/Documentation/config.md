...
remote.NAME.replicateNotVisibleProjects
:	If true, projects not visible for replication user will be replicated
	to the remote site.

	By default, false, do *not* replicate not visible projects.
