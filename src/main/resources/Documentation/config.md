...
Directory `replication.remotes.d`
--------------------
The optional directory `$site_path/etc/replication.remotes.d` contains Git-style
...
Remote sections in `$site_path/etc/replication.remotes.d` directory:

* File `$site_path/etc/replication.remotes.d/host-one.config`
...
* File `$site_path/etc/replication.remotes.d/pubmirror.config`
