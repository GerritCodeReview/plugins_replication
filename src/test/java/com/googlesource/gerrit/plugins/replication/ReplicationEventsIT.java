  ...
  public void shouldEmitProjectDeletionEventsForOneRemote() throws Exception {
    ...
    assertThat(
            testDispatcher.getMatching(
                    projectName, ProjectDeletionReplicationScheduledEvent.class))
        .hasSize(1);
    ...
    assertThat(
            testDispatcher.getMatching(
                    projectName, ProjectDeletionReplicationSucceededEvent.class))
        .hasSize(1);
    assertThat(
            testDispatcher.getMatching(
                    projectName, ProjectDeletionReplicationDoneEvent.class))
        .hasSize(1);
  }
