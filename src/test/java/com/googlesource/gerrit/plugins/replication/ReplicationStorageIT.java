...
public class ReplicationStorageIT extends LightweightPluginDaemonTest {
  ...
  private static final int TEST_REPLICATION_RETRY_MINUTES = 1; // this is minutes TODO
  ...
  private FileBasedConfig setReplicationDestination(
      ...
      throws IOException {
    return setReplicationDestination(remoteName, replicaSuffixes, project, replicationDelay, false);
  }
