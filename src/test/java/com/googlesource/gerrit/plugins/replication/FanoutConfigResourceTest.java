...
import static com.googlesource.gerrit.plugins.replication.FileConfigResourceTest.assertEmptyConfig;
...
public class FanoutConfigResourceTest extends AbstractConfigTest {
  ...
  public void setupTests() {
    ...
    assertThat(sitePaths.etc_dir.resolve(CONFIG_DIR).toFile().mkdir()).isTrue();
  }
  ...
  public void shouldAddConfigOptionToMainConfig() throws Exception {
    ...
    Config rest = objectUnderTest.update(update);
    Config updatedConfig = objectUnderTest.getConfig();

    assertEmptyConfig(rest);
