...
public class EventFieldsTest {
  ...
  public void refReplicatedEventFields() throws URISyntaxException {
    ...
    assertEquals("someHost", event.targetNode);
    assertEquals("git://someHost:9417/basePath/", event.targetUri);
  ...
  public void scheduledEventFields() throws URISyntaxException {
    ...
    ReplicationScheduledEvent event =
        new ReplicationScheduledEvent(
            "someProject", "refs/heads/master", completeUri.getHost(), completeUri);
