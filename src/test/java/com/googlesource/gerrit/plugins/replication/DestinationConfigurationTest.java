...
public class DestinationConfigurationTest {
  ...
  public void shouldDefaultUrlDistributionToAll() {
    assertThat(objectUnderTest.getUrlDistribution()).isEqualTo(UrlDistribution.ALL);
  }
  ...
  public void shouldSetUrlDistributionToRoundRobinWhenConfigured() {
    ...
    // when / then
    assertThat(objectUnderTest.getUrlDistribution()).isEqualTo(UrlDistribution.ROUND_ROBIN);
  }
}
