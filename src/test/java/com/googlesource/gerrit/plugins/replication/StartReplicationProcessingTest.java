...
/**
 * The intention of this series of tests, is to test that all variations of the StartReplicationRequest
 * which is derived from the posted data, are executed correctly. The testing of Http request
 * parsing, is performed in the companion class, ParseStartReplicationRequestTest.
 */
...
public class StartReplicationProcessingTest {
  ...
  public void testStartAll() throws IOException {
    ...
    setUpMocks();
    StartReplicationRequest StartReplicationRequest = createStartReplicationRequest(cmd, project, urlMatch);
  ...
  public void testStartSingleProjectWaitAndStop() throws IOException {
    ...
    StartReplicationRequest StartReplicationRequest =
        createStartReplicationRequest(cmd, project, urlMatch, true, false);
    startReplicationProcessing.execute(StartReplicationRequest, responseMock, replicationStateLoggerMock);
  ...
  public void testStartBadCommand() throws IOException {
    StartReplicationRequest StartReplicationRequest =
        createStartReplicationRequest("allall", "dummy", "gerrit.com");
    startReplicationProcessing.execute(StartReplicationRequest, responseMock);
  ...
  private StartReplicationRequest createStartReplicationRequest(String cmd, String project) {
  ...
  private StartReplicationRequest createStartReplicationRequest(String cmd, String project, String url) {
    StartReplicationRequest StartReplicationRequest = createStartReplicationRequest(cmd, project);
  ...
  private StartReplicationRequest createStartReplicationRequest(
    ...
    StartReplicationRequest StartReplicationRequest = createStartReplicationRequest(cmd, project, url);
