...
public class ReplicationDistributorIT extends ReplicationStorageDaemon {
  ...
  public void distributorAddingTaskFromStorage() throws Exception {
    ...
    assertThat(waitForProjectTasksCount(0, TEST_PUSH_TIMEOUT))
        .isTrue(); // replication work completed
  ...
  private boolean waitForProjectTasksCount(int count, Duration duration) {
    try {
