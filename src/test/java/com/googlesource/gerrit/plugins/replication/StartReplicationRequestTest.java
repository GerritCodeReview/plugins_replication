...
public class StartReplicationRequestTest {
  ...
  public void testStartAll() throws IOException {
    final String cmd = "all";
    final String project = "anyproject";
    final String urlMatch = "gerrit.com";

    setUpMocks();
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project, urlMatch);
    startReplicationRequest.execute(startCommandMsg, responseMock);
  ...
  public void testStartSingleProject() throws IOException {
    final String cmd = "project";
    final String project = "anyproject";
    final String urlMatch = "gerrit.com";
    final String projectAlt = "anotherproject";
  ...
  @Test
  public void testStartSingleProjectWaitFalse() throws IOException {
    final String cmd = "project";
    final String project = "anyproject";
    final String urlMatch = "gerrit.com";
    final String projectAlt = "anotherproject";
    ...
    setUpMocks();
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project, urlMatch, true, false);
    startReplicationRequest.execute(startCommandMsg, responseMock);
    verify(responseMock).setStatus(SC_NO_CONTENT);
    assertEquals(urlMatch, acUrlMatch.getValue());
    ReplicationFilter replicationFilter = acReplicationFilter.getValue();
  ...
  public void testStartSingleProjectNoUrl() throws IOException {
    ...
    setUpMocks();
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project);
    startReplicationRequest.execute(startCommandMsg, responseMock);
    verify(responseMock).setStatus(SC_NO_CONTENT);
  ...
  public void testStartSingleProjectWaitAndNowNullFuture() throws IOException {
    final String cmd = "project";
    final String project = "anyproject";
    final String urlMatch = "gerrit2.com";
    final String projectAlt = "anotherproject";

    setUpMocks();
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project, urlMatch, true, true);
    startReplicationRequest.execute(startCommandMsg, responseMock);
  ...
  public void testStartSingleProjectWaitAndStop() throws IOException {
    final String cmd = "all";
    final String project = "anyproject2";
    final String urlMatch = "gerrit-dev.com";
    ...
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project, urlMatch, true, false);
    startReplicationRequest.execute(startCommandMsg, responseMock, replicationStateLoggerMock);
  ...
  public void testStartBadCommand() throws IOException {
    ...
    StartCommandMsg startCommandMsg = createStartCommandMsg("allall", "dummy", "gerrit.com");
    startReplicationRequest.execute(startCommandMsg, responseMock);
  ...
  private StartCommandMsg createStartCommandMsg(String cmd, String project) {
    StartCommandMsg startCommandMsg = new StartCommandMsg();
    startCommandMsg.setCommand(cmd);
    startCommandMsg.setProject(project);
    return startCommandMsg;
  }

  private StartCommandMsg createStartCommandMsg(String cmd, String project, String url) {
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project);
    startCommandMsg.setUrl(url);
    return startCommandMsg;
  }

  private StartCommandMsg createStartCommandMsg(
      String cmd, String project, String url, boolean wait, boolean now) {
    StartCommandMsg startCommandMsg = createStartCommandMsg(cmd, project, url);
    startCommandMsg.setWait(wait);
    startCommandMsg.setNow(now);
    return startCommandMsg;
  }
}
