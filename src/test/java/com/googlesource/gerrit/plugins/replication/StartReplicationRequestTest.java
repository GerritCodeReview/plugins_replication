 ...
 * processing that occurs after this class gets instantiated, is tested in the companion class,
...
public class StartReplicationRequestTest {
  ...
  public void setUp() throws Exception {
    servlet = new EventRestApiServlet(startReplicationProcessingMock);
  }
  ...
  public void testStartAll() throws IOException {
    ...
    CommandType receivedCommand = acStartReplicationRequest.getValue().getCommand();
    assertEquals(cmd, receivedCommand.toString().toLowerCase());
