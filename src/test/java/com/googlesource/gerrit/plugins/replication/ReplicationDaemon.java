...
public class ReplicationDaemon extends LightweightPluginDaemonTest {
  ...
  protected Project.NameKey createTestPermissionsProject(String name) throws Exception {
    return projectOperations.newProject().name(name).permissionsOnly(true).create();
  }
  ...
  protected void setPermissionsReplication(String remoteName, boolean replicatePPermissions)
      throws IOException {
